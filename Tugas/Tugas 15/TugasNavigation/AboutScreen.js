...
export default function AboutScreen() {
    ...
    return (
        <View style={styles.container}>
            ...
            <Text style={{ marginTop: 15, fontSize: 25, color: "#003366", fontWeight: 'bold' }}>Candra Octavian Ramadhani</Text>
            ...
            <View style={styles.portofolio}>
                ...
                <View style={styles.listPortofolio}>
                    <View style={styles.detailPortofolio}>
                        ...
                        <Text style={{ marginLeft: 10 }}>coctavian</Text>
                    </View>
                    <View style={styles.detailPortofolio}>
            ...
            <View style={styles.kontak}>
                ...
                <View style={styles.listKontak}>
                    <View style={styles.detailKontak}>
                        ...
                        <Text style={{ marginLeft: 10 }}>Candra Octav</Text>
                    </View>
                    <View style={styles.detailKontak}>
                        <AntDesign name="instagram" size={34} color="#003366" />
                        <Text style={{ marginLeft: 10 }}>candraoctavianr</Text>
                    </View>
                    <View style={styles.detailKontak}>
                        <AntDesign name="twitter" size={34} color="#003366" />
                        <Text style={{ marginLeft: 10 }}>candra_octav</Text>
                    </View>
                </View>
            </View>
        </View>
