...
export default function SkillScreen() {
    ...
    return (
        <View style={styles.container}>
            <Image source={require('../TugasNavigation/images/logo-sanber.png')} style={{ width: 180, height: 50, alignSelf: 'flex-end' }} />
            <View style={styles.userContainer}>
                <Image source={require('../TugasNavigation/images/profilepic.jpg')} style={{ width: 35, height: 35, borderRadius: 300, marginTop: 10 }} />
                <View style={{ flexDirection: 'column', paddingLeft: 10 }}>
                    <Text style={{ color: "#003366" }}>Hi,</Text>
                    <Text style={{ color: "#003366" }}>Candra Octavian Ramadhani</Text>
                </View>
            </View>
            <Text style={{
